      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              searchBuilder("Donate household goods to H4H:", "https://www.google.com/maps/search/habitat+for+humanity+restore/@${coord.latitude},${coord.longitude},13z/data=!3m1!4b1", context),
